...
class PostImageDataValidation
{
    public ?int $post_image_id = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->post_image_id = isset($data['post_image_id']) ? $this->validateInteger($data['post_image_id'], 'post_image_id') : null;
        $this->post_id = isset($data['post_id']) ? $this->validateInteger($data['post_id'], 'post_id') : null;
